...
@interface AddImageView : NSObject


@property (nonatomic, strong) NSString *imagename;
@property (nonatomic) int thisheight;
@property (nonatomic) int thiswidth;
@property (nonatomic) float thispositionX;
@property (nonatomic) float thispositionY;
@property (nonatomic) bool thisvisibility;
@property (nonatomic) int thisscaleType;
@property (nonatomic) float thisrotateDegree;
@property (nonatomic) float thisopacity;
